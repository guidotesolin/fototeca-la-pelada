...
/**
 * One file: the scale's roles use 400 and 500. The italics are the source note and
 * nothing else, and the source note belongs to the photo page (T7): it comes back
 * when that screen exists, without preload, which is where 23 KB does not compete
          ...
          <div className="max-w-content mx-auto w-full px-4 pb-14 sm:px-6 sm:pb-22">
            ...
            <div className="flex flex-col gap-1.5 pt-4.5 sm:flex-row sm:items-baseline sm:justify-between sm:gap-8 sm:pt-5">
              ...
              <span className="t-meta">
                {facts.photos}&nbsp;fotografías · {sections.length}&nbsp;secciones ·{' '}
                {facts.families}&nbsp;familias · {facts.from}&ndash;{facts.to}
              </span>
            </div>
