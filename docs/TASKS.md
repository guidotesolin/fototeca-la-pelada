...
| F56     | `Incendios rurales` has no proposal in any of the three languages                                                                                              | Surfaced by `npm run translations:export` in T16 and **not introduced by it**: the string is in the database and in none of the three proposal files, so it was added from the panel after the last export ran. It is one section name. Left rather than translated in passing, because content the card did not ask for is content nobody reviewed; the export has recorded it now, which is the part that was missing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | whoever runs the editor next                                  |
