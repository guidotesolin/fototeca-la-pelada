...
| F26     | The original/restored switch has never run against a real restoration                                                                                          | No photograph has one: `restored_web_key` is null for all 592. The markup and its CSS were verified against the shipped stylesheet, the query path was not — attaching a fixture row to the database was not permitted                                                                                                                                      | T10, which is what attaches the first one                     |
